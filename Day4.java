...
public class Day4 {
    ...
    public static void main(String args[]) {
        ...
        for(String passPhrase: input) {
            ...
            for(String word:passPhrase.split(" ")) {
                ...
                Arrays.sort(newWord);
                if (!alreadyUsedWords.add(new String(newWord))) {
                    valid = false;
                    break;
                }
            }
    ...
    private static List<String> input = Arrays.asList("pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk",
